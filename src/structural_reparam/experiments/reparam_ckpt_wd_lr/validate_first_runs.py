"""Early validation for the reparam_ckpt_wd_lr campaign (user-mandated gates).
...
group (`reparam_wd_d5_*` / `sweeps100_*_lr_wd5e4_d5`); report deltas against
the original group's across-seed noise. (Same seeds/recipe, but probe removal
changes RNG consumption, so expect seed-level closeness, not bit-identity.)

Usage:
  python -m structural_reparam.experiments.reparam_ckpt_wd_lr.validate_first_runs \
...
GROUP_MAP = {  # ckpt100 group -> original group
    "ckpt100_c100_wd_d5": "reparam_wd_d5_c100",
    "ckpt100_c10_wd_d5": "reparam_wd_d5_c10",
    "ckpt100_c100_lr_wd5e4_d5": "sweeps100_c100_lr_wd5e4_d5",
    "ckpt100_c10_lr_wd5e4_d5": "sweeps100_c10_lr_wd5e4_d5",
}
